...
export const roleController = {
  findUnique: roleRouter.get(
    "/:id",
    async (req: Request<{ id: string }>, res: Response<TRoleSingleResponse>) => {
      const { id } = req.params;
  ...
  findMany: roleRouter.get(
    "/",
    async (req: Request<TMetaRequest>, res: Response<TRoleResponse>) => {
      try {
